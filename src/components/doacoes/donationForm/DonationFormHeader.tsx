    ...
    return (
        <ModalHeader p={8} bgColor='blue.800' borderTopRadius='md'>
            ...
            <Flex alignItems='center' justifyContent='space-between' px={{base: 0, lg: 8}}>
                <Text fontWeight='semibold' fontSize={{base: 12, lg: 16}} color='gray.300' letterSpacing='1.2'>Valor da doação</Text>
            ...
            <Flex alignItems='center' justifyContent='space-between' px={{base: 0, lg: 8}}>
                <Text fontWeight='semibold' fontSize={{base: 12, lg: 16}} color='gray.300' letterSpacing='1.2'>Meses de assinatura</Text>
                <Text fontWeight='bold' fontSize={{base: 12, lg: 18}} color='gray.50' letterSpacing='1.2'>
