...
export function Donate({products}: DonateProps) {
    ...
    return (
        ...
        >
            ...
            <Box color='gray.50' textAlign='start' flex='.4'>
                <Text 
                    fontWeight='bold' 
            ...
            <Box color='gray.50' pl={{base: 4, lg: 8}} flex='.3' textAlign='start'>
                ...
                <Flex alignItems='end' gap={4} mt={2}>
                    <Select variant='flushed' fontSize={{base: 14, lg: 20}} w={{base: '75%', lg: '40%'}} onChange={(e) => setCycles(Number(e.target.value))}>
