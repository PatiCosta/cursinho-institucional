      ...
      <VStack as="form" onSubmit={handleSubmit(onSubmit)} spacing={6} align="stretch">
        ...
        <VStack spacing={4} align="flex-start">
          <FormControl isInvalid={!!errors.aceiteTermoCiencia}>
            ...
            >
              Eu li e aceito o <Link href={'https://drive.google.com/file/d/17KFQVgR8v46ArvdaCUuwgfxs_Q1RcaN9/view'} isExternal color="blue.500">Termo de Ciência</Link> (Obrigatório)
            </Checkbox>
          ...
          <FormControl isInvalid={!!errors.aceiteTermoInscricao}>
            ...
            >
              Eu li e aceito o <Link href={selectedTurma.documents?.find(doc => doc.title.includes('Inscrição'))?.downloadLink} isExternal color="blue.500">
